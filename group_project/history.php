...
<body onload="scrollFunction();">
    ...
    <div class="main-div">
        ...
        <div class="section-div section-reverse">
            ...
            <div class="img-div">
                <img class="img2" src="assets/media/unix_pc1.jpg" alt="PC">
            </div>
        </div>
        <div class="section-div">
            <div class="img-div">
                <img class="img1" src="assets/media/unix_pc2.jpg" alt="PC">
            </div>
            <div class="founder1">
                <p class="section-txt">
        ...
        <div class="section-div section-reverse">
            ...
            <div class="img-div">
                <img class="img2" src="assets/media/macos_screen.jpg" alt="PC">
            </div>
        </div>
    </div>
