...
<body onload="scrollFunction();">
    ...
    <div class="main-div">
        ...
        <div class="section-div">
            <div class="img-div">
                <img class="types_img" src="assets/media/aix_img.png" alt="AIX">
            </div>
            <div class="navigation">
                <h1>IBM AIX</h1>
        ...
        <div class="section-div">
            <div class="img-div">
                <img class="types_img" src="assets/media/tru64_img.jpg" alt="TRU64">
            </div>
            <div class="navigation">
                <h1>TRU64 UNIX</h1>
        ...
        <div class="section-div">
            ...
            <div class="img-div">
                <img class="types_img" src="assets/media/macos_img.png" alt="macOS">
            </div>
        </div>
    </div>
