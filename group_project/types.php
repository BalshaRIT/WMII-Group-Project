    ...
    <div class="main-div">
        ...
        <div class="section-div section-reverse">
            <div class="navigation">
                ...
                <div class="button-div">
                    <a class="learn-btn1" href="hp_ux.php">Learn More</a>
                </div>
            </div>
            <div class="img-div">
                <img class="types_img" src="assets/media/hp_ux_img.png" alt="HP-UX">
            </div>
        </div>
        <div class="section-div">
            <div class="img-div">
        ...
        <div class="section-div section-reverse">
            <div class="navigation">
                ...
                <div class="button-div">
                    <a class="learn-btn1" href="net_bsd.php">Learn More</a>
                </div>
            </div>
            <div class="img-div">
        ...
        <div class="section-div">
            ...
            <div class="navigation">
                ...
                <div class="button-div">
                    <a class="learn-btn1" href="xenix.php">Learn More</a>
                </div>
            </div>
        </div>
        <div class="section-div section-reverse">
            <div class="navigation">
                ...
                <div class="button-div">
                    <a class="learn-btn1" href="sgi_irix.php">Learn More</a>
                </div>
            </div>
            <div class="img-div">
