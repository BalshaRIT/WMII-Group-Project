...
<body onload="scrollFunction();">
            ...
            <ul class="nav-links">
                ...
                <li>
                    ...
                    <ul class="mega-links">
                        ...
                        <li><a class="active-nav" href="free_bsd.php">FreeBSD</a></li>
    ...
    <div class="main-div">
        <h1>FreeBSD</h1>
        <p class="center-section-txt">FreeBSD was originally developed in the early 1990s as a fork of the 386BSD
            operating system, which was itself a derivative of BSD UNIX.
            FreeBSD is a popular choice for web servers, with many popular web sites, including Yahoo!, Sony, and Netflix,
            running on FreeBSD servers.
        </p>
        <div class="section-div section-reverse">
            <p class="section-txt width">&emsp;&emsp;FreeBSD is known for its excellent documentation, which includes a comprehensive handbook and
                a large online community that provides support and assistance to users.
            </p>
            <div class="img-div">
        ...
        <div class="section-div">
            <div class="img-div full-div">
                <img class="types_img" src="assets/media/free_bsd_img2.png" alt="FreeBSD">
            </div>
            <p class="section-txt width">&emsp;&emsp;FreeBSD is released under a permissive open-source license, which allows users to modify
                and distribute the operating system as they see fit.
                FreeBSD is highly scalable and can run on a wide range of hardware architectures, including x86, ARM, MIPS, and PowerPC.
            </p>
        </div>
        <p class="center-section-txt">&emsp;&emsp;FreeBSD is designed to be highly secure, with features such as a built-in firewall,
            strong encryption support, and a robust access control system.
            FreeBSD is actively developed and maintained by a large and vibrant community of developers, who work to continually
            improve the operating system and add new features and capabilities.
        </p>
    </div>
