...
<body onload="scrollFunction();">
    ...
    <div class="main-div">
            ...
            <div class="flip-box">
                <div class="flip-box-inner">
                    <div class="flip-box-front">
                      <img src="assets/media/comm_img.png" alt="unix" class="flip_img">
        ...
        <p class="center-section-txt">Unix commands are case-sensitive. For example, "ls" and "LS" are different commands.
        ...
        <p class="center-section-txt">Many Unix commands can be combined using pipes ("|") and redirects
            (">" and "<") to perform more complex operations.
