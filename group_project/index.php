...
<body onload="scrollFunction();">
        ...
        <div class="wrapper">
            ...
            <ul class="nav-links">
                ...
                <li>
                    ...
                    <a id="invisible-types" href="types.html">Visit Types</a>
    ...
    <div class="welcome-div">
        ...
        <div class="circle-container">
            <div class="circle">
                <img class="img1" src="assets/media/rm_img.png" alt="rm Command">
            </div>
            <div class="circle">
                <img class="img1" src="assets/media/cd_img.png" alt="cd Command">
            </div>
            <div class="circle">
                <img class="img1" src="assets/media/ls_img.png" alt="ls Command">
            </div>
        </div>
    </div>
    ...
    <div class="info1">
        <div class="div1">
            ...
            <a class="learn-btn" href="about.html">Learn More</a>
        </div>
        <div class="div1">
            ...
            <a class="learn-btn" href="history.html">Learn More</a>
        </div>
        <div class="div1">
            ...
            <a class="learn-btn" href="types.html">Learn More</a>
        </div>
    </div>
    ...
    <div class="info3">
        <div class="txt">
            ...
            <div class="button-div">
                <a class="learn-btn" href="quiz.html">View Quiz</a>
            </div>
        </div>
