...
<body onload="scrollFunction();">
    ...
    <div class="main-div">
        ...
        <div class="center-img-div">
            <img class="img_s" src="assets/media/tutorial_searchbar.png" alt="SearchBar">
        </div>
        <p class="center-section-txt">Step #2 - Search for either "Terminal" or "Command Prompt" and open the program.</p>
        <div class="center-img-div">
            <img class="img_s" src="assets/media/cmd.png" alt="CMD">
        </div>
        ...
        <div class="center-img-div">
            <img class="img_s" src="assets/media/commands.png" alt="commands">
        </div>
        ...
        <div class="center-img-div">
            <img class="img_s" src="assets/media/rem.png" alt="Rename">
        </div>
        ...
        <div class="center-img-div">
            <img class="img_s" src="assets/media/mkdir.png" alt="mkdir">
        </div>
